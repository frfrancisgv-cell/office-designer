...
var o_bi_formats;
var bi_formats = o_bi_formats = (function(){
                    return {
                      html: {
                        bold: ["<b>", "</b>"],
                        italic: ["<i>", "</i>"],
...
var o_g_tones;
var g_tones = o_g_tones = {'1.':{clef:"c4",
...
function syllable(match,index,bi) {
  ...
  if(typeof(match)=="string"){
    ...
    var getTagsFrom = function(str) { return []; };
...
if(typeof window !== 'undefined'){window['getPsalm'] = getPsalm;
